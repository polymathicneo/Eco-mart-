...
const blogContent = {
    0: {
        ...
        fullContent: `
            <p>We often think of pollution as being physical—exhaust, trash, or sludge. But our digital habits have a massive environmental impact too. Every email sent, every movie streamed, and every photo stored in the cloud requires energy. This energy powers the massive data centers that keep the internet running, and much of it still comes from fossil fuels.</p>
    ...
    2: {
        ...
        fullContent: `
            <p>Bamboo is having a moment. From flooring to underwear, toothbrushes to skyscrapers, this giant grass is everywhere. But is it really the sustainable savior it's claimed to be? The short answer is yes—if harvested responsibly.</p>
    ...
    3: {
        ...
        fullContent: `
            <p>"Sustainable Fashion" is a trendy term, but what does it actually mean? The fashion industry is currently responsible for about 10% of global carbon emissions—more than all international flights and maritime shipping combined. Shifting to a sustainable model isn't just a preference; it's a necessity.</p>
            ...
            <p>At EcoMart, we champion local artisans like those making our Pashmina shawls. These items are handmade with care, support traditional livelihoods, and are built to last a lifetime—the antithesis of disposable fashion.</p>
        `
    },
    4: {
        ...
        fullContent: `
            ...
            <p>Recycling alone won't save us—current recycling rates are too low. The solution lies in "Refuse and Reduce."</p>
            <ul>
    ...
    5: {
        ...
        fullContent: `
            <p>Can high-tech gadgets actually help the planet? It seems counterintuitive—more devices mean more e-waste and energy use. However, the rise of "Smart Home" technology offers unique opportunities to optimize our energy consumption and reduce waste in ways that manual habits struggle to match.</p>
